...
## Environments
- Preview: https://main--sausaxen-cub--aemysites.aem.page/
- Live: https://main--sausaxen-cub--aemysites.aem.live/
...
1. Open the `sausaxen-cub` directory in your favorite IDE and start coding :)
